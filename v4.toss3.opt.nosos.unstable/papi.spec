...
Name: %{?scl_prefix}ovis-papi
Version: %{scl_name_version}
Release: 1.0%{?dist}
License: GPLv2 or BSD
Group: %{ldms_all}
BuildRoot: %{_tmppath}/%{name}-%{version}-%{release}-root-%(%{__id_u} -n)
Source: papi-6.0.0.tar.gz
Requires: rpm >= 4.8.0
...
rm -f $RPM_BUILD_ROOT%{_libdir}/ovis-ldms/papi-6.0.0/*.la
...
%files
%defattr(-,root,root)
%{_libdir}/ovis-ldms/papi-6.0.0/lib/*
%{_libdir}/ovis-ldms/papi-6.0.0/share/papi/papi_events.csv
%exclude %{_libdir}/ovis-ldms/papi-6.0.0/lib/pkgconfig
%exclude %{_libdir}/ovis-ldms/papi-6.0.0/lib/pkgconfig/*
#end core
...
%files util
%defattr(-,root,root)
%{_libdir}/ovis-ldms/papi-6.0.0/bin/*
#end util
...
%files devel
%defattr(-,root,root)
%{_libdir}/ovis-ldms/papi-6.0.0/include/*.h
%{_libdir}/ovis-ldms/papi-6.0.0/include/*/*.h
%{_libdir}/ovis-ldms/papi-6.0.0/lib/pkgconfig/*
#end devel
...
%files doc
%defattr(-,root,root)
%{_libdir}/ovis-ldms/papi-6.0.0/share/man/*/*
